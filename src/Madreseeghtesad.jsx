  ...
  <div>
    <Helmet>
      ...
      <div className="Madrese-bg">
          <div className='Madrese-content'>
              ...
              <div className="Madrese-content-texts">
                  <h1>{t('اهمیت کسب و کار تو از نگاه ثبات‌داده')}</h1>
                  <p>{t('در عصر هوش مصنوعی و داده محور شدن تمامی کسب و کارها، ثبات داده تلاش می کند تا مشاوره ای اقتصادی را بر پایه استاندارد های جهانی را برای تجارت شما به ارمغان سازد.')}</p>
              </div>
          </div>
      </div>
      <div className="Madrese-content2">
          ...
          {activeSection === 0 && (
            <p>{t('در این بخش ثبات داده طرح جامع کسب و کار شما را با استفاده ابزار های اقتصادی سنجی در اختیار شما قرار می دهد. طرح جامع کسب و کار هر کسب و کار سندی است که اهداف، خدمات، محصولات، جایگاه صنعتی، اهداف بازاریابی و پیش‌بینی‌های مالی آن کسب و کار را توصیف می‌کند. اطلاعاتی که در یک پلن کاری در کنار هم قرار می‌گیرند، می‌توانند راهنمای بسیار مفیدی برای اداره و توسعه کسب و کار شما باشند. به‌علاوه، بسیاری از مدیران از پلن کسب و کار جهت تامین مالی و جذب سرمایه‌گذار استفاده می‌کنند. business plan به شما کمک می‌کند تا بفهمید می‌خواهید چه محصول یا خدمتی را به چه کسی با چه قیمتی ارائه کنید و چگونه آن را به مشتری یا مخاطب خود برسانید؛ محصول یا خدمت شما چه سودی به مشتری می‌رساند؟')}</p>
          )}
          {activeSection === 1 && (
              <p>{t('استفاده از تکنیک‌های تحلیل رقبا باعث می‌شود با خیال راحت به نتایج آنالیز رقبای خود اتکا کنید. درواقع این روش‌ها پیش‌ازاین امتحان خود را پس داده‌اند. اطلاعاتی که تکنیک‌های تحلیل رقبا در اختیار ما قرار می‌دهند در پیدا کردن مسیر صحیح فعالیت‌های ما بسیار مؤثر هستند. برای مقایسه داده‌ها و تحلیل رقیبان، اول‌ازهمه باید مشخص کنید با چه کسانی رقابت می‌کنید. آنچه در کسب‌وکارهای مشابه شما اثر دارد، لزوماً در برند شما هم جواب نمی‌دهد. خب، چطور می‌توانید رقبا را مشخص کنیم؟ رقبای خودتان را در دودسته قرار بدهید: مستقیم و غیرمستقیم. رقبای مستقیم کسب‌وکارهایی هستند که محصول یا خدماتی مشابه شما ارائه می‌دهند و می‌تواند جایگزین شما باشد. این رقبا همچنین در منطقه جغرافیایی مشابه شما فعالیت دارند. رقبای غیرمستقیم کسانی هستند که محصولاتشان با شما یکسان نیست اما نیازهای یکسانی را برطرف می‌کنند. گفتنش آسان است، اما در عمل بسیاری اوقات این دو اصطلاح با هم اشتباه گرفته می‌شوند.')}</p>
          )}
          {activeSection === 2 && (
              <p>{t('چرا باید از خدمات مشاوره مالیاتی استفاده کرد؟ پیچیدگی و تعدد قوانین مالیاتی تمامی کسب و کارها نیاز به دریافت خدمات مشاوره مالیاتی دارند. مشاوران مالیاتی شرکت ثبات داده سال هاست که مشاور مالیاتی شرکت های بزرگ و کوچک بوده اند و تجارب ارزنده ای در این حوزه کسب کرده اند. مشاوران مالی موسسه مالی ازتا، با تمامی سرفصل های مالیاتی آشنا هستند و تمامی چالش های مالیاتی انواع شرکت های سهامی، غیر تجاری، تضامنی، مسئولیت محدود و غیره را برطرف خواهند کرد. به عنوان مثال، مالیات پزشکان مشمول قوانین بسیار پیچیده ای است و تنظیم اظهارنامه های مالیاتی مشاغل صنعت پزشکی نیازمند دانش و تجربه قابل توجهی است. شرکت حسابداری اَزتا به صورت تخصصی به پرونده های مالیاتی پزشکان رسیدگی میکند. مزیت رقابتی شرکت حسابداری ازتا نسبت به سایر شرکت های حسابداری، پیگیری پرونده های مالیاتی است. پیگیری پرونده های مالیاتی و دفاع مالیاتی برای کسانی که آشنایی با مسائل مالیاتی ندارند، بسیار پیچیده، زمانبر و به شدت پر هزینه است.')}</p>
          )}
          {activeSection === 3 && (
              <p>{t('به واقع چرا با پیشرفت مدرنیته، ضرورت استفاده و کمک گرفتن از مشاوره حقوقی، ضرورت بیشتری یافته است؟ در روزگاری که آن را عصر مدرنیته می نامند و از ویژگی های اصلی این عصر، تنوع و گستردگی روابط انسانی و پیچیده در مناسبات اجتماعی است، طبعا، بروز چالش های بین فردی یا گروهی، از تبعات منطقی اثر مدرنیته است. اغلب چالش های مذکور، جنبه حقوقی داشته، و در واقع مناقشات و اختلافات افراد با یکدیگر، غالبا ماهیت حقوقی دارد؛ و همین نکته، ضرورت کارکرد مشاوره حقوقی را اثبات می کند. در جوامع ماقبل مدرنیته، اختلافات، معمولا از طریق کدخدا منشی و مو سفیدی، حل و فصل می گردید. ضمن اینکه طرفین اختلاف نیز، تمایل بیشتری به تصامح و مدارا، از خود نشان می دادند. اما امروزه، به دلیل افزایش کمیت و پیچیدگی اختلاف ها، مراجعه به مراجع حقوقی و تشکیل پرونده های قضایی، به طور چشمگیری، رو به فزونی است؛ لذا از آنجا که امور حقوقی و قضایی، یک موضوع کاملا تخصصی است، ضرورت مراجعه به مشاوره حقوقی، امری اجتناب ناپذیر است.')}</p>
          )}
          {activeSection === 4 && (
              <p>{t('تمدن بین النهرینی و غرب آسیا همواره در عرصه های گوناگون تجارت بین المللی از جایگاه ویژه ای برخوردار بوده است. حضور بازرگانان غربی و شرقی در این میراث باستانی نشان از محبوبیتی دیرینه برای برای تجار دارد.کارشناسان ثبات داده با تجربه ده ها سال مشاوره اقتصادی، تجارتی و بانکی در پهنه خاورمیانه می توانند با ارائه سبد های سرمایه گذاری متنوع چشم اندازی روشنی را در پیشگاه شما قرار می دهد.')}</p>
          )}
          {activeSection === 5 && (
              <p>{t('مشاوره طراحی سایت یکی از کارهای مهم، تاثیرگذار، هزینه‌بر و چالش‌برانگیز است. بدون مشاوره در این زمینه حتی اگر مجری سایت شما شرکت مایکروسافت هم باشد ممکن است مسیر درست طی نشود. مشاوره در این مورد بخصوص یعنی تبادل اطلاعات و همفکری. اطلاعاتی که زمینه‌ساز تصمیم‌های بهتر، مسیرهای کوتاه‌تر و هزینه‌های کمتر می‌شود. قبل از راه‌اندازی هر کار مهمی مشورت کنید خصوصا ساختن یک سایت خوب. این مطلب نگاهی است به روش درست و اصولی مشورت با اهالی فناوری در رابطه با راه‌اندازی سایت. مشاوره بگیرید تا چرخ را از اول اختراع نکنید. طراح سایت ساختن سایت را می‌داند اما شما را نمی‌شناسند. او در مورد صنعت، حوزه کاری، نگرش‌ها، مشکلات، انتظارات و حتی بودجه اطلاعات دقیقی ندارد. بنابراین بدون مشاوره چیزی خلق خواهد شد که ممکن است چکش‌کاری آن به قیمت دوباره ساختنش بینجامد. پس اولین فایده مشاوره شناخت کافی مجری از روند چیزی است که شما قرار است در سایت خود عرضه یا ارائه کنید.')}</p>
          )}
      </div>
          <div className="Madrese-content2-lists">
            <a className={activeSection === 0 ? 'Madrese-active-list' : ''} onClick={(e) => handleSectionClick2(e, 0)}>{t('طرح جامع کسب و کار')}</a>
            <a className={activeSection === 1 ? 'Madrese-active-list' : ''} onClick={(e) => handleSectionClick2(e, 1)}>{t('تحلیل بازارهای رقیب')}</a>
            <a className={activeSection === 2 ? 'Madrese-active-list' : ''} onClick={(e) => handleSectionClick2(e, 2)}>{t('مشاوره مالیاتی')}</a>
            <a className={activeSection === 3 ? 'Madrese-active-list' : ''} onClick={(e) => handleSectionClick2(e, 3)}>{t('مشاوره حقوقی')}</a>
            <a className={activeSection === 4 ? 'Madrese-active-list' : ''} onClick={(e) => handleSectionClick2(e, 4)}>{t('مشاوره سرمایه گذاری')}</a>
            <a className={activeSection === 5 ? 'Madrese-active-list' : ''} onClick={(e) => handleSectionClick2(e, 5)}>{t('مشاوره IT')}</a>
          </div>
      </div>
      <div className='Madrese-sabt-darkhast'>
          <h1>{t('همین حالا کسب و کار تو قدرتمند کن !')}</h1>
          <button type="submit">{t('ثبت درخواست مشاوره')}</button>
      </div>
      <h1 className='Madrese-roadmap-header'>{t('ثبات‌داده قراره دقیقا چیکار کنه ؟')}</h1>
      ...
      <div className='Madrese-roadmap-box' id='m3' ref={sectionRefs[2]}>
          <img src={madrese4} alt="icon"/>
          <div className='Madrese-roadmap-box-texts'>
              <h1>{t('مشاوره مالیاتی')}</h1>
              <p>
              <ul>
                <li>{t('مشاوره مالیاتی و مالی')}</li>
                <li>{t('خدمات حسابداری مالیاتی و مالی')}</li>
                <li>{t('انجام امور پایانه های فروشگاهی و سامانه مودیان مالیاتی و سامانه جامع تجارت')}</li>
                <li>{t('خدمات حسابرسی و تهیه صورت های مالی')}</li>
                <li>{t('مشاوره مالیات بر ارزش افزوده')}</li>
                <li>{t('تنظیم و ارسال اظهارنامه عملکرد')}</li>
                <li>{t('تنظیم و ارسال صورتحساب معاملات فصلی')}</li>
                <li>{t('مشاوره مالیات اجاره املاک، سرقفلی و مالیات بر ارث')}</li>
                <li>{t('تهیه و تنظیم بودجه بندی مالی')}</li>
                <li>{t('مهندسی مالی و مالیاتی')}</li>
              </ul>{t('چرا باید از خدمات مشاوره مالیاتی استفاده کرد؟ پیچیدگی و تعدد قوانین مالیاتی تمامی کسب و کارها نیاز به دریافت خدمات مشاوره مالیاتی دارند. مشاوران مالیاتی شرکت ثبات داده سال هاست که مشاور مالیاتی شرکت های بزرگ و کوچک بوده اند و تجارب ارزنده ای در این حوزه کسب کرده اند. مشاوران مالی موسسه مالی ازتا، با تمامی سرفصل های مالیاتی آشنا هستند و تمامی چالش های مالیاتی انواع شرکت های سهامی، غیر تجاری، تضامنی، مسئولیت محدود و غیره را برطرف خواهند کرد. به عنوان مثال، مالیات پزشکان مشمول قوانین بسیار پیچیده ای است و تنظیم اظهارنامه های مالیاتی مشاغل صنعت پزشکی نیازمند دانش و تجربه قابل توجهی است. شرکت حسابداری اَزتا به صورت تخصصی به پرونده های مالیاتی پزشکان رسیدگی میکند. مزیت رقابتی شرکت حسابداری ازتا نسبت به سایر شرکت های حسابداری، پیگیری پرونده های مالیاتی است. پیگیری پرونده های مالیاتی و دفاع مالیاتی برای کسانی که آشنایی با مسائل مالیاتی ندارند، بسیار پیچیده، زمانبر و به شدت پر هزینه است.')}</p>
          </div>
      </div>
      <div className='Madrese-roadmap-box2' id='m4' ref={sectionRefs[3]}>
          <img src={madrese5} alt="icon"/>
          <div className='Madrese-roadmap-box-texts2'>
              <h1>{t('مشاوره حقوقی')}</h1>
              <p>{t('به واقع چرا با پیشرفت مدرنیته، ضرورت استفاده و کمک گرفتن از مشاوره حقوقی، ضرورت بیشتری یافته است؟ در روزگاری که آن را عصر مدرنیته می نامند و از ویژگی های اصلی این عصر، تنوع و گستردگی روابط انسانی و پیچیده در مناسبات اجتماعی است، طبعا، بروز چالش های بین فردی یا گروهی، از تبعات منطقی اثر مدرنیته است. اغلب چالش های مذکور، جنبه حقوقی داشته، و در واقع مناقشات و اختلافات افراد با یکدیگر، غالبا ماهیت حقوقی دارد؛ و همین نکته، ضرورت کارکرد مشاوره حقوقی را اثبات می کند. در جوامع ماقبل مدرنیته، اختلافات، معمولا از طریق کدخدا منشی و مو سفیدی، حل و فصل می گردید. ضمن اینکه طرفین اختلاف نیز، تمایل بیشتری به تصامح و مدارا، از خود نشان می دادند. اما امروزه، به دلیل افزایش کمیت و پیچیدگی اختلاف ها، مراجعه به مراجع حقوقی و تشکیل پرونده های قضایی، به طور چشمگیری، رو به فزونی است؛ لذا از آنجا که امور حقوقی و قضایی، یک موضوع کاملا تخصصی است، ضرورت مراجعه به مشاوره حقوقی، امری اجتناب ناپذیر است.')}</p>
          </div>
      </div>
      {/* next row */}
