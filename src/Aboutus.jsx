        ...
        <a href="https://www.maj.ir/" target="_blank" rel="noopener noreferrer">
          <img src="https://sobotdadeh.com/manabeimg/danesh12.webp" alt="جهاد کشاورزی" />
            ...
            <div className="kharid">
                <h1>{t('به ثبات‌داده اعتماد کن ما کنارتان هستیم ...')}</h1>
