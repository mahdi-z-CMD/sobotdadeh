        ...
        <div className="Khareji">
            ...
            <div className="Khareji-select-country">
                ...
                <div className="Khareji-select-map">
                    ...
                    <div className="Khareji-select-map-country">
                        ...
                        <h1 className={country === 4 ? 'Khareji-select-map-country-active' : ''} onClick={()=>setCountry(4)}>{t('عمان')}</h1>
                    </div>
                </div>
            </div>
            ...
            <div className='Khareji-country-about'>
                ...
                <div className="Khareji-country-about-2">
                    <h1>{country === 0 ? t('درباره ایــــــــران') : country === 1 ? t('درباره عراق') : country === 3 ? t('درباره عربستان سعودی') : country === 2 ? t('درباره قطر') : country === 4 ? t('درباره عمان') : null}</h1>
